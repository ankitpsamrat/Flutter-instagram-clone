...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getData() async {
    ...
    try {
      ...
      postLen = postSnap.docs.length; //  post fetch
      userData = userSnap.data()!; //  user fetch
      followers = userSnap.data()!['followers'].length; //  followers fetch
      following = userSnap.data()!['following'].length; //  following fetch
        ...
        : Scaffold(
            ...
            body: ListView(
              children: [
                ...
                // fetch post from db to display in profile section
